...
## Slang Localization Rule

- NEVER edit generated files under `lib/gen/i18n/` manually.
- Only add or update translation keys in `assets/i18n/*.json`.
- After locale changes, regenerate files with: `fvm dart run slang`.
